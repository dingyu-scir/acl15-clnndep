...
class NNClassifier
{
    ...
    private:
         ...
         * P : Weight matrix for the linear projection for word embeddings
         */
        static Mat<double> W1, W2, P, Eb, Ed, Ev, Ec;
        static Vec<double> b1;
        static Mat<double> project;
        /*
        Mat<double> grad_W1;
        Vec<double> grad_b1;
        Mat<double> grad_W2;
        ...
        */
        ...
        Mat<double> eg2W1, eg2W2, eg2P, eg2Eb, eg2Ed, eg2Ev, eg2Ec;
        Vec<double> eg2b1;
